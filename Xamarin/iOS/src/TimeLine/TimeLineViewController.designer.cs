...
namespace EarthLens.iOS.TimeLine
{
    ...
    partial class TimeLineViewController
    {
        ...
        [Outlet]
        [GeneratedCode ("iOS Designer", "1.0")]
        UIKit.UIButton DataVisualizerBtn { get; set; }
        ...
        [Outlet]
        [GeneratedCode ("iOS Designer", "1.0")]
        UIKit.NSLayoutConstraint SidebarXOffset { get; set; }
        ...
        [Action ("DataVisualizerBtn_TouchUpInside:")]
        [GeneratedCode ("iOS Designer", "1.0")]
        partial void DataVisualizerBtn_TouchUpInside (UIKit.UIButton sender);
